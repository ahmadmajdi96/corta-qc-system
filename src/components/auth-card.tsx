      ...
      <div className="w-full max-w-md bg-card rounded-xl shadow-lg border p-8">
        <div className="flex flex-col items-center text-center mb-6">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-2xl font-bold tracking-tight text-primary">CORTA QC</span>
          </div>
          <div className="text-sm text-muted-foreground">Quality Control Platform</div>
        </div>
        {error && (
        ...
        <form onSubmit={submit} className="space-y-4" noValidate>
          ...
          {mode === "signin" && (
            <button
              type="button"
              disabled
              className="block mx-auto text-xs text-muted-foreground cursor-not-allowed"
            >
              Forgot password?
            </button>
          )}
